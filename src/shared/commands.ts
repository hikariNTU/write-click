...
export const COMMANDS = {
  ...
  "tab.moveLeft": { labelKey: "cmd_tab_moveLeft", where: "background" },
  "tab.moveRight": { labelKey: "cmd_tab_moveRight", where: "background" },
  "tab.moveToStart": { labelKey: "cmd_tab_moveToStart", where: "background" },
  "tab.moveToEnd": { labelKey: "cmd_tab_moveToEnd", where: "background" },
  "tab.closeDuplicates": { labelKey: "cmd_tab_closeDuplicates", where: "background" },
  "tab.muteAll": { labelKey: "cmd_tab_muteAll", where: "background" },
  "tab.group": { labelKey: "cmd_tab_group", where: "background" },
  "tab.ungroup": { labelKey: "cmd_tab_ungroup", where: "background" },
  "group.collapseOthers": { labelKey: "cmd_group_collapseOthers", where: "background" },
  "open.history": { labelKey: "cmd_open_history", where: "background" },
  "open.downloads": { labelKey: "cmd_open_downloads", where: "background" },
  "open.bookmarks": { labelKey: "cmd_open_bookmarks", where: "background" },
  "open.extensions": { labelKey: "cmd_open_extensions", where: "background" },
  "page.viewSource": { labelKey: "cmd_page_viewSource", where: "background" },
  "page.copyUrl": { labelKey: "cmd_page_copyUrl", where: "content" },
  "page.copyTitle": { labelKey: "cmd_page_copyTitle", where: "content" },
  "page.print": { labelKey: "cmd_page_print", where: "content" },
