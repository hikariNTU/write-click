...
| [UX-02](ux-02-trigger-tutorial.md) | **done** | Teach the trigger instead of describing it: reframe the question, add a try-it pad and an animation. |
...
~~4. **FEAT-04** — the catalogue gaps, each one small.~~ done.
